...
const advantages = [
  {
    ...
    description:
      'Stop paying $500–$2,000/mo for generic SaaS tools that force you into their templates. We build custom platforms that match your exact workflow. You choose how to pay: buy it outright, or subscribe to a managed platform at a fraction of SaaS cost.',
  },
  {
    icon: Puzzle,
...
export function StudioValuePropositionSection() {
  return (
      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
        <SectionWrapper className="text-center mb-16">
          ...
          <h2 className="text-3xl lg:text-5xl font-medium text-white leading-[1.2]">
            Software that finally works for you.
          </h2>
        </SectionWrapper>
